...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is DaYi_NetWork
                   DESC

  s.homepage     = "http://192.168.0.25:3000/DaYi_Repo/DaYi_NetWork"
  ...
  s.source       = { :git => "http://192.168.0.25:3000/DaYi_Repo/DaYi_NetWork.git", :tag => s.version.to_s }
  ...
  s.source_files  = "DaYi_NetWork/DaYi_NetWork/**/*.{h,m,swift}"
